...
class Mt_flow:
    ...
    def load(self):
        ...
        categoricas = [
            ...
            'Tuition fees up to date', 'Gender', 'Scholarship holder', 'International', 'Application mode', 'Application order','Target']
    ...
    def formato(self, df):
        ...
        cuantitativas = list(formato.loc[formato["Formato"] != "O", "Variable"])
